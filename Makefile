...
AUDFPRINT=python audfprint.py --density 100
...
test_onecore_precomppk: precomppkdir
	...
	${AUDFPRINT} new --dbase fpdbase.pklz precomppkdir/Nine_Lives/1*
	${AUDFPRINT} merge --dbase fpdbase.pklz fpdbase0.pklz
	${AUDFPRINT} match --dbase fpdbase.pklz precomppkdir/query.afpk
	rm -rf precomppkdir
